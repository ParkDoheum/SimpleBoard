...
<form name="frm" action="write" method="post" onsubmit="return chkSubmit()">
	...
	제목 : <input type="text" name="board_title" value="제목1"><br>
	내용 <textarea name="board_content" rows="10" cols="10">내용1</textarea><br>
	날짜 : <input type="text" name="regdate" value="20181029"><br>
